...
_JSON error messages (if any):_ `Owner privilege missing`, `Login already taken`, `Password too weak`, `Invalid country`, `Invalid email syntax`, `Name already taken` (for campaign).
