...
**Warning**: Maximum request size is 1048576 bytes.
...
**Warning**: If you're receiving **HTTP "204 No content"** response check if `id` member is present in your Requests. Lack of this member means that the Request is a Notification - signifies the Clients lack of interest in receiving Response as explained [here](http://www.jsonrpc.org/specification#notification).
...
####get_import_stats<a name="get_import_stats"/>
