...
version 1.2.1, 2012-03-29 [changelog](#changelog)
...
Download module for your Wordpress version from [Downloads](https://github.com/GetResponse/DevZone/downloads) section.
...
5. Modify the position of your web form from your WordPress settings.
