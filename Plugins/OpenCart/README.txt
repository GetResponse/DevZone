...
Download module from https://github.com/GetResponse/DevZone/tree/master/Plugins/OpenCart/plugin_opencart-1.3.zip

1. Copy content of this archive to OpenCart top level.(opencart_01.gif)

2. In the administration panel go to "Extensions"=>"Modules" setting.(opencart_02.gif)

3. Click "Edit" button in "GetResponse" row and insert API key (copy your secret API key from https://app.getresponse.com/my_api_key.html), and choose the campaign name. (opencart_03.gif)
